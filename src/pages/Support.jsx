...
export default function Support() {
  ...
  const faqs = [
    { question: "What are your shipping options?", answer: "We offer free standard shipping (3-5 business days) and express delivery (24-48 hours) for all orders." },
    { question: "What warranty do you provide?", answer: "All devices come with a 1-year official manufacturer warranty." },
    { question: "What are your support hours?", answer: "Our customer support team is available Monday to Saturday, 9 AM to 9 PM." }
  ];
          ...
          <div className="w-full max-w-5xl">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              <motion.div 
                ...
                className="lg:w-1/2 p-5 rounded-xl bg-white/[0.03] backdrop-blur-xl border border-white/10"
              >
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    <label className="text-[10px] uppercase tracking-wider text-zinc-600 block mb-1">Email</label>
                    <input
                      type="email"
                      required
                  ...
                  <div>
                    <label className="text-[10px] uppercase tracking-wider text-zinc-600 block mb-1">Message</label>
                    <textarea
                      required
                      rows={2}
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.99 }}
                    className="w-full py-2.5 rounded-lg bg-white text-black text-xs font-semibold uppercase tracking-wider hover:bg-zinc-200 transition-colors flex items-center justify-center gap-2"
                  >
                    Send Message
              ...
              >
                <div className="flex-1 p-4 rounded-xl bg-white/[0.03] backdrop-blur-xl border border-white/10 space-y-3">
                ...
                <motion.button
                  whileHover={{ scale: 1.01 }}
                  whileTap={{ scale: 0.99 }}
                  className="py-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10 text-white text-xs font-medium uppercase tracking-wider hover:bg-white/10 transition-colors flex items-center justify-center gap-2"
                >
